    	   ...
    	   $scope.submitSignup = function(signupForm){
               ...
               //user[email],user[password],user[departement],user[info] 
				...
				$.ajax({
					...
					data:"user[Typologie]="+"1"+"&user[RaisonSociale]="+""+"&user[civ]="+"1"+
							"&user[last_name]="+"Léau"+"&user[first_name]="+"Maxime"+"&user[email]="+"maximeleau18@gmail.com"+
							"&user[password]="+"Azerty@1234"+"&user[departement]="+"53"+
							"&trombifile="+""+"&user[info]="+"0",
					type:"POST",
					dataType:"json",   
